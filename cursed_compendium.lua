...
local function addCompendiumPages(pages)
    ...
    table.insert(pages, 
    {
        ...
        },
        {
            ...
            spr = entitydef.curse_strengthen,
            header = "Dark Curses",
            content =
    ...
    {
        {
            ...
            content =
            "CURSE MOD\n While you are holding the Solar Morningstar, defeating a negative enemy will slightly (80%) weaken the closest negative enemy. Rounding will occur so the displayed value is the real value. Tiebreakers for proximity prioritize Up, Down, Left, Right."
        },
        {
            unlock_flag = "royal_boon_lunar",
            ...
            content =
            "CURSE MOD\nWhile you are holding the Scimitar of Lunacy, defeating a positive enemy will slightly (120%) strengthen the furthest positive enemy. Lunacy effects may stack and apply together (a 3k enemy with 2 lunacy stacks would become a 4k). Tiebreakers for proximity prioritize Up, Down, Left, Right."
        },
    })
end
