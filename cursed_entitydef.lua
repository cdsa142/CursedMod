...
local function addCursedEntities(entitydef, enemy_can_interact, enemy_interact, enemy_undo_store)
    entitydef.mirror_enemy = {
        ...
        can_interact = enemy_can_interact,
        undo_store = enemy_undo_store,
        interact = function(ent, game)
            enemy_interact(ent, game)
